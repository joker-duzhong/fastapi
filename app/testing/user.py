...
from app.testing.utilities import random_email, random_lower_string
...
async def create_random_user(db: AIOSession) -> User:
    email = random_email()
...
async def authentication_token_from_email(
    *, client: AsyncClient, email: str, db: AIOSession
) -> Dict[str, str]:
    """
